...
const SHOP_BY_NEED_CARDS: readonly NeedCard[] = [
  ...
  },
  {
    ...
    imageSrc: "/assest/Paw Care.png",
    imageAlt: "Dog in a yellow sweater",
    tone: "peach",
  },
  {
    ...
    href: "/shop",
    imageSrc: "/assest/shopbg.png",
    imageAlt: "Puppies and kitten peeking over a table",
    tone: "cream",
  },
  {
  ...
  },
  {
    ...
    imageSrc: "/assest/Cat Essentials.png",
    imageAlt: "Orange and white cat outdoors",
    tone: "mint",
  },
];
